...
function showSummaryScreen(summary) {
    ...
    let localizedMedal = summary.medal || "KEINE";
    if (localizedMedal === "NONE") localizedMedal = "KEINE";
    else if (localizedMedal === "GOLD") localizedMedal = "GOLD";
    else if (localizedMedal === "SILVER") localizedMedal = "SILBER";
    else if (localizedMedal === "BRONZE") localizedMedal = "BRONZE";

    const text =
        "Team: " + (summary.playerName || "-") + "\n" +
        "Punkte: " + (summary.totalPoints ?? 0) + " / " + (summary.maxPoints ?? 0) + "\n" +
        "Score: " + (summary.scoreOutOf100 ?? 0) + " / 100\n" +
        "Medaille: " + localizedMedal;
